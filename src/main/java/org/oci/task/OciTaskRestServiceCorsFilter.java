...
public class OciTaskRestServiceCorsFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) throws IOException {
        ...
        responseContext.getHeaders().add("Access-Control-Allow-Headers", "origin, content-type, accept, authorization, X-Requested-With, Content-Type, Accept, Origin, Authorization");
